...
class StatusGraphView: UIView {
    ...
    var graphColor = UIColor (red: 255.0/255.0, green: 142.0/255.0, blue: 28.0/255.0, alpha: 1.0)
    ...
    override func drawRect(rect: CGRect) {
        ...
        // Graph size
        graphWidth = (rect.size.width - padding) - 2.5
        graphHeight = rect.size.height - 10
