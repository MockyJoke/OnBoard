 ...
 */
@property (nonatomic, strong) TKAlertContentView *headerView;

/**
 TKAlert's content view.
 */
@property (nonatomic, strong) TKAlertContentView *contentView;

/**
 TKAlert's buttons view.
 */
@property (nonatomic, strong) TKAlertButtonsView *buttonsView;
